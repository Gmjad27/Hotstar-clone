...
interface BaseCastCredit extends BasePersonCredit {
    character: string;
    order: number;
}
interface BaseCrewCredit extends BasePersonCredit {
    department: string;
    job: string;
}
...
interface MoviesGetCreditsCast extends BaseCastCredit {
    cast_id: number;
}
type MoviesGetCreditsCrew = BaseCrewCredit;
...
type MoviesGetDetailsResponse<AppendToResponse extends MoviesAppendToResponse[] | undefined> = MoviesGetDetailsBaseResponse & AppendToResponseType<AppendToResponse, "movie">;
...
interface PeopleBaseCastGetMovieCredit extends PeopleCastAndCrewGetCombinedGetMovieCredit, PeopleCastCreditSpecificFields {
    order: number;
}
type PeopleBaseCrewGetMovieCredit = PeopleCastAndCrewGetCombinedGetMovieCredit & PeopleCrewCreditSpecificFields;
type PeopleBaseCastGetTvCredit = PeoplePersonCredit & {
    character: string;
};
type PeopleBaseCrewGetTvCredit = PeoplePersonCredit & PeopleCrewCreditSpecificFields;
interface PeopleGetTvCreditsPerson {
    origin_country: string[];
    original_name: string;
    first_air_date: string;
    name: string;
...
type PeopleGetCombinedCreditsCast = PeopleBaseCastGetMovieCredit & {
    media_type: "movie" | "tv";
    original_title?: string;
} & Partial<PeopleGetTvCreditsPerson>;
type PeopleGetCombinedCreditsCrew = PeopleBaseCrewGetMovieCredit & {
    media_type: "movie" | "tv";
    original_title?: string;
} & Partial<PeopleGetTvCreditsPerson>;
...
type PeopleGetDetailsResponse<AppendToResponse extends PeopleAppendToResponse[] | undefined> = PeopleGetDetailsBaseResponse & AppendToResponseType<AppendToResponse, "people">;
...
type PeopleGetMovieCreditsCast = PeopleBaseCastGetMovieCredit & {
    original_title: string;
};
type PeopleGetMovieCreditsCrew = PeopleBaseCrewGetMovieCredit & {
    original_title: string;
};
...
type PeopleGetTvCreditsCast = PeopleGetTvCreditsPerson & PeopleBaseCastGetTvCredit;
type PeopleGetTvCreditsCrew = PeopleGetTvCreditsPerson & PeopleBaseCrewGetTvCredit;
...
type SearchMultiSearchResponse = PaginatedResponse<SearchMultiSearchResult>;
...
type SearchMultiSearchParams = SearchQueryParams;

type SearchCollectionsResponse = PaginatedResponse<SearchCollectionsResult>;
...
interface SearchCollectionsParams extends SearchQueryParams {
    region?: string;
}

type SearchCompaniesResponse = PaginatedResponse<SearchCompaniesResult>;
...
type SearchCompaniesParams = BaseQueryParams;

type SearchKeywordsResponse = PaginatedResponse<SearchKeywordsResult>;
interface SearchKeywordsResult {
    id: number;
    name: string;
}
type SearchKeywordsParams = BaseQueryParams;

type SearchMoviesResponse = PaginatedResponse<SearchMoviesResult>;
...
interface SearchMoviesParams extends SearchQueryParams {
    region?: string;
    year?: string;
    primary_release_year?: string;
}

type SearchPeopleResponse = PaginatedResponse<SearchPeopleResult>;
...
type SearchPeopleParams = SearchQueryParams;

type SearchTVShowsResponse = PaginatedResponse<SearchTVShowsResult>;
...
interface SearchTVShowsParams extends SearchQueryParams {
...
type BaseAggregateCredits = Omit<BasePersonCredit, "credit_id"> & {
    total_episode_count: number;
};
interface TVGetAggregateCreditsCast extends BaseAggregateCredits {
    roles: (TvGetAggregateCreditsRole & {
        character: string;
    })[];
    order: number;
}
interface TVGetAggregateCreditsCrew extends BaseAggregateCredits {
    jobs: (TvGetAggregateCreditsRole & {
        job: string;
    })[];
    department: string;
}
...
type TVGetCreditsCast = BaseCastCredit;
type TVGetCreditsCrew = BaseCrewCredit;
...
type TVGetDetailsResponse<AppendToResponse extends TVAppendToResponse[] | undefined> = TVGetDetailsBaseResponse & AppendToResponseType<AppendToResponse, "tv">;
...
type TVEpisodesGetDetailsResponse<AppendToResponse extends TVEpisodesAppendToResponse[] | undefined> = TVEpisodesGetDetailsBaseResponse & AppendToResponseType<AppendToResponse, "tv_episodes">;
...
type TVSeasonsGetDetailsResponse<AppendToResponse extends TVSeasonsAppendToResponse[] | undefined> = TVSeasonsGetDetailsBaseResponse & AppendToResponseType<AppendToResponse, "tv_seasons">;
...
type ResponseTypeFor<T, U> = U extends "movie" ? T extends keyof MoviesAppendToResponseTypes ? MoviesAppendToResponseTypes[T] : never : U extends "tv" ? T extends keyof TVAppendToResponseTypes ? TVAppendToResponseTypes[T] : never : U extends "people" ? T extends keyof PeopleAppendToResponseTypes ? PeopleAppendToResponseTypes[T] : never : U extends "tv_seasons" ? T extends keyof TVSeasonsAppendToResponseTypes ? TVSeasonsAppendToResponseTypes[T] : never : U extends "tv_episodes" ? T extends keyof TVEpisodesAppendToResponseTypes ? TVEpisodesAppendToResponseTypes[T] : never : never;
type ExtractValidKeys<T> = T extends (infer U)[] ? U : never;
type AppendToResponseType<AppendToResponse extends (MoviesAppendToResponse | TVAppendToResponse | PeopleAppendToResponse | TVSeasonsAppendToResponse | TVEpisodesAppendToResponse)[] | undefined, ResponseType extends ResponseTypes> = AppendToResponse extends undefined ? object : {
